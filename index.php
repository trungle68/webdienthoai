...
<div class="container">
	<ul class="ul_menu">
		<li><a href="index.php">ĐIỆN THOẠI</a>
			<ul class="menu">
				<li><a href="IP8.php">Apple</a></li>
				<li><a href="SS_A5.php">Samsung</a></li>
				<li><a href="oppo_a57.php">Oppo</a></li>
				<li><a href="oppo_f1_plus.php">Vivo</a></li>
...
<div class="container" style="margin-top: 20px">
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 line_right">
			<a href="IP8.php"><p>Xem thêm các điện thoại khác</p></a>
		</div>
	</div>
</div>
